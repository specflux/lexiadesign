...
if ( ! function_exists( 'lexia_block_stylesheets' ) ) :
	/**
	 ...
	 * @return void
	 */
	function lexia_block_stylesheets() {
		/**
		...
		wp_enqueue_block_style(
			'core/button',
			array(
				'handle' => 'lexia-button-style-outline',
...
add_action( 'init', 'lexia_block_stylesheets' );
...
if ( ! function_exists( 'lexia_pattern_categories' ) ) :
	...
	function lexia_pattern_categories() {
		...
		register_block_pattern_category(
			'lexia_page',
			array(
				'label'       => _x( 'Pages', 'Block pattern category', 'lexia' ),
				'description' => __( 'A collection of full page layouts.', 'lexia' ),
			)
		);
	}
endif;
