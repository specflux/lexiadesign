...
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Learn about our product', 'lexiadesign' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Got a question? We got you covered! Check out the resources below and be sure to let us know if we can answer anything else.', 'lexiadesign' ); ?></p>
<!-- /wp:paragraph -->
...
<h3 class="wp-block-heading" style="font-style:normal;font-weight:600"><?php esc_html_e( 'What exactly is Lexia?', 'lexiadesign' );?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Lexia is a WordPress block theme specifically designed to work with the new WordPress Site Editor. This means you can build your website using drag-and-drop blocks, pre-designed patterns, and other intuitive elements, all without needing any coding skills.', 'lexiadesign' );?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="has-base-700-color has-text-color has-link-color"><?php esc_html_e( 'Let\'s have a chat!', 'lexiadesign' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
