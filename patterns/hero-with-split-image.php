...
<!-- wp:group {"style":{"dimensions":{"minHeight":"70vh"}},"backgroundColor":"brand-900","className":"alignfull has-base-color has-text-color has-background"} -->
<div class="wp-block-group alignfull has-base-color has-text-color has-background has-brand-900-background-color" style="min-height:70vh">
...
<h1 class="wp-block-heading has-text-5-xl-font-size has-base-100-color has-text-color has-link-color">
...
<p class="has-base-100-color has-text-color has-link-color">
...
<!-- wp:button {"backgroundColor":"brand","textColor":"base-0","style":{"elements":{"link":{"color":{"text":"var:preset|color|base-0"}}}}} -->
...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/laptop-on-table.webp","id":76,"dimRatio":0,"isDark":false,"style":{"dimensions":{"aspectRatio":"1"},"border":{"radius":"15px"}},"layout":{"type":"constrained"}} -->
