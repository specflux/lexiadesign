...
<div class="wp-block-group alignwide are-vertically-aligned-top has-base-100-color has-border-color has-brand-900-border-color has-brand-800-background-color has-background has-link-color" style="border-width:1px;border-radius:15px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:group {"className":"is-vertically-aligned-top has-base-100-color has-text-color has-background","layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group is-vertically-aligned-top has-base-100-color has-text-color has-background"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"500"},"layout":{"selfStretch":"fit","flexSize":null}},"fontSize":"xxxx-large"} -->
<p class="has-text-align-center has-xxxx-large-font-size" style="font-style:normal;font-weight:500"><?php echo esc_html_e( '$59', 'lexiadesign' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:heading {"level":4,"className":"has-base-100-color","style":{"elements":{"link":{"color":{"text":"var:preset|color|base-100"}}}},"textColor":"base"} -->
<h4 class="wp-block-heading has-base-100-color has-base-color has-text-color has-link-color"><?php echo esc_html_e( 'Professional Package', 'lexiadesign' ); ?></h4>
<!-- /wp:heading -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|x-small"}},"fontSize":"small","layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group has-small-font-size"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"},"layout":{"selfStretch":"fit","flexSize":null}},"layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"top","justifyContent":"center"}} -->
...
<!-- wp:separator {"className":"is-style-separator-dotted is-style-default","style":{"layout":{"selfStretch":"fit","flexSize":null}}} -->
...
<!-- wp:paragraph -->
<p><?php echo esc_html_e( 'And many more', 'lexiadesign' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
