...
?>
<!-- wp:group {"align":"full","className":"has-base-100-color","style":{"spacing":{"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large","right":"var:preset|spacing|small","left":"var:preset|spacing|small"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"brand-900","textColor":"base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-base-100-color has-base-color has-brand-900-background-color has-text-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xx-large);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--xx-large);padding-left:var(--wp--preset--spacing--small)"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"x-large"} -->
<p class="has-x-large-font-size" style="font-style:normal;font-weight:500">"<?php echo esc_html_e( 'Building my website used to be a daunting task, but Lexia have completely changed the game! With pre-designed patterns, I was able to create a beautiful and professional website even with limited design experience. It\'s like having a personal design assistant at my fingertips!', 'lexiadesign' ); ?>"</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:paragraph {"className":"has-base-100-color has-text-color"} -->
<p class="has-base-100-color has-text-color">
