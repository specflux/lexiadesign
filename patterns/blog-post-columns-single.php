...
<div class="wp-block-group alignfull has-main-background-color has-background start" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)">
    ...
    <div class="wp-block-query alignwide">
        <!-- wp:post-template {"fontSize":"large"} -->
            <!-- wp:columns {"verticalAlignment":"center","displayLayout":{"type":"flex"}} -->
                <div class="wp-block-columns are-vertically-aligned-center">
                    <!-- wp:column {"verticalAlignment":"center"} -->
                    <div class="wp-block-column is-vertically-aligned-center">
                        <!-- wp:post-featured-image {"isLink":true,"height":"120px","style":{"color":{}}} /-->
                    </div>
                    <!-- /wp:column -->
                    ...
                    <div class="wp-block-column is-vertically-aligned-center">
                        ...
                        <div class="wp-block-group">
                            ...
                            <!-- wp:post-date {"textColor":"main-accent","fontSize":"small"} /-->
                        </div>
                        <!-- /wp:group -->
                    </div>
                    <!-- /wp:column -->
