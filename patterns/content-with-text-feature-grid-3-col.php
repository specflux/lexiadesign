 ...
 * @ai-layout: centered, grid-3col, full-width
 ...
 * @ai-repeater: feature_cards, min:3, max:6
 */
?>
...
<p class="has-text-align-center"><?php esc_html_e( 'Our comprehensive suite of professional services caters to a diverse clientele, ranging from homeowners to commercial developers.', 'lexiadesign' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-column">
<!-- wp:heading {"textAlign":"left","level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"600","textDecoration":"underline"}},"className":"is-style-asterisk","fontSize":"medium","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-left is-style-asterisk has-body-font-family has-medium-font-size" style="font-style:normal;font-weight:600;text-decoration:underline"><?php esc_html_e( 'Project Management', 'lexiadesign' ); ?></h3>
<!-- /wp:heading -->
