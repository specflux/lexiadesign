...
<div class="wp-block-query alignwide">
    ...
    <div class="wp-block-group">
        ...
        <!-- wp:post-template {"align":"full","style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"grid","columnCount":3}} -->
        ...
        <div class="wp-block-group has-border-color"
            style="border-color:#111111;border-width:1px;border-radius:15px;min-height:100%;padding-right:0;padding-left:0">

            <!-- wp:post-featured-image {"isLink":true,"aspectRatio":"3/4","style":{"spacing":{"margin":{"bottom":"0"},"padding":{"bottom":"var:preset|spacing|small"}},"border":{"radius":"0px"}}} /-->
            ...
            <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--small);padding-top:0;padding-right:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)">

                <!-- wp:post-author-name {"style":{"spacing":{"padding":{"right":"0","left":"0"}}},"fontSize":"small"} /-->
        ...
        <div style="margin-top:0;margin-bottom:0;height:var(--wp--preset--spacing--medium)" aria-hidden="true"
