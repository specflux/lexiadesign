...
<!-- wp:post-navigation-link {"type":"previous","label":"<?php echo esc_html_e( 'Previous: ', 'Label before the title of the previous post. There is a space after the colon.', 'lexiadesign' ); ?>","showTitle":true,"linkLabel":true,"arrow":"arrow"} /-->
<!-- wp:post-navigation-link {"label":"<?php echo esc_html_e( 'Next: ', 'Label before the title of the next post. There is a space after the colon.', 'lexiadesign' ); ?>","showTitle":true,"linkLabel":true,"arrow":"arrow"} /-->
</nav>
<!-- /wp:group -->
