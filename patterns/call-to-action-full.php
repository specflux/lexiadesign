...
<h2 class="wp-block-heading has-text-align-center">Design with clicks, not code</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Let loose your imagination and easily create beautiful websites with the LexiaDesign block theme powered by the new WordPress Site Editor. Animating Ideas into Realities!</p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"primary","fontSize":"text-base"} -->
<div class="wp-block-button has-custom-font-size has-text-base-font-size"><a class="wp-block-button__link has-primary-background-color has-background wp-element-button">Download Now</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
