...
<!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base-0"}}}},"textColor":"base-100"} -->
<h2 class="wp-block-heading has-base-100-color has-text-color has-link-color">

    <?php esc_html_x( 'Boost your productivity. Start using our app today.', 'Sample heading', 'lexiadesign' ); ?>
...
<!-- wp:paragraph -->
<p>
    <?php esc_html_x( 'Ac euismod vel sit maecenas id pellentesque eu sed consectetur. Malesuada adipiscing sagittis vel nulla.', 'Sample content', 'lexiadesign' ); ?>
</p>
<!-- /wp:paragraph -->
...
<a class="wp-block-button__link has-brand-background-color has-background wp-element-button">
    ...
    <?php esc_html_e( 'CTA', 'lexiadesign' ); ?>
</a></div>
<!-- /wp:button -->
...
<a class="wp-block-button__link has-base-100-color has-text-color has-link-color wp-element-button">
    ...
    <?php esc_html_e( 'Secondary Button','lexiadesign' ); ?>
</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center">
<!-- wp:image {"id":76,"sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":"25px"}}} -->
<figure class="wp-block-image size-large has-custom-border">
<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/people-2.webp" alt="" class="wp-image-76" style="border-radius:25px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->