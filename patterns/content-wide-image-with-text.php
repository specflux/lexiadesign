...
<?php esc_html_x( 'Image and Text Card', 'Sample heading', 'lexiadesign' ); ?>
</h4>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>
    <?php esc_html_x( 'Now we can whip up stunning, full-page designs with gorgeous patterns in a flash, all thanks to the awesome new Site Editor and Lexia themes. WordPress just became way cooler than a bucket and spade!  ✨', 'Sample content', 'lexiadesign' ); ?>
</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:button {"backgroundColor":"brand","textColor":"base-0","width":50,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base-0"}}}},"className":"is-style-fill"} -->
...
<?php esc_html_e( 'Get Started', 'lexiadesign' ); ?>
</a></div>
<!-- /wp:button -->

<!-- wp:button {"width":50,"className":"is-style-secondary-button is-style-outline"} -->
<div class="wp-block-button has-custom-width wp-block-button__width-50 is-style-secondary-button is-style-outline">
<a class="wp-block-button__link wp-element-button">
<?php esc_html_e( 'Read More', 'lexiadesign' ); ?>
</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
