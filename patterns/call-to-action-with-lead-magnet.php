...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:33.33%"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/spiral.webp","id":33150,"dimRatio":0,"focalPoint":{"x":0.48,"y":0.47},"minHeight":281,"minHeightUnit":"px","isDark":false,"style":{"color":{"duotone":"unset"}},"className":"is-style-rounded-cover"} -->
<div class="wp-block-cover is-light is-style-rounded-cover" style="min-height:281px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-33150" alt="" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/spiral.webp" style="object-position:48% 47%" data-object-fit="cover" data-object-position="48% 47%"/><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:heading {"level":3,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base-0"}}}},"textColor":"base-0"} -->
<h3 class="wp-block-heading has-base-0-color has-text-color has-link-color">Ditch the design struggle</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Unleash your inner website wizard with the brand new WordPress Site Editor and Lexia block theme! Craft captivating, one-of-a-kind websites that'll have your visitors saying "Wowzers!" (without needing any coding hocus pocus). So ditch the design struggle and get ready to build something truly magnificent! ✨</p>
<!-- /wp:paragraph -->

<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button {"backgroundColor":"brand","width":100} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-brand-background-color has-background wp-element-button" href="https://lexia.com">Download Lexia for free!</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
