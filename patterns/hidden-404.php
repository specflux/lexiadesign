...
<?php echo esc_html_x( 'Page Not Found', 'Sample heading for 404 page', 'lexiadesign' ); ?>
</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|base-100"}}}},"textColor":"base-100","fontSize":"medium"} -->
<p class="has-base-100-color has-text-color has-link-color has-medium-font-size">
<?php echo esc_html_x( 'The page you are looking for does not exist, or it has been moved. Please try searching using the form below.', 'Sample paragraph for 404 page', 'lexiadesign' ); ?>
</p>
<!-- /wp:paragraph -->
