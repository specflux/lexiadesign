...
<div class="wp-block-group has-main-background-color has-background has-brand-100-background-color" style="border-radius:15px;padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"align":"center","textColor":"base","className":"has-base-color has-text-color has-text-2-xl-font-size","fontSize":"medium"} -->
<p class="has-text-align-center has-base-color has-text-color has-text-2-xl-font-size has-medium-font-size">As a busy entrepreneur, I don't have time to mess around with code. Block themes have been a lifesaver! I can quickly add stunning layouts with relevant functionalities like contact forms and testimonials, all within the user-friendly block editor. It's saved me time and money, and most importantly, my website looks amazing</p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full is-resized is-style-circle"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/people-3.webp" alt="" class="wp-image-58" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
