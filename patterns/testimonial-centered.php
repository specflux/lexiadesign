...
<p class="has-text-align-center has-base-0-color has-text-color has-x-large-font-size" style="font-style:normal;font-weight:500"><br><em>"<?php echo esc_html_e( 'The attention to detail and strategic thinking behind every decision exceeded our expectations. From concept to launch,', 'lexiadesign' ); ?><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-base-100-color">the team delivered a polished, professional result that truly represents our brand.</mark> I couldn't recommend them highly enough."</em><br></p>
<!-- /wp:paragraph -->
