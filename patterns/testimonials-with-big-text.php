...
<div class="wp-block-group alignfull" style="border-radius:5px;margin-top:0;margin-bottom:0"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"fontSize":"small"} -->
<p class="has-text-color has-small-font-size" style="font-style:normal;font-weight:500">Testimonials</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading"><strong><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color ">Ditch the code, embrace the whoosh!</mark></strong> Build beautiful websites in a flash with the drag-and-drop power of the WordPress Site Editor. </h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->

<!-- wp:column {"verticalAlignment":"center"} -->
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|medium","padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"}},"border":{"radius":"15px"}},"backgroundColor":"brand-100","className":"is-style-column-box-shadow","layout":{"type":"constrained"}} -->
